...
const withExamTags = async (exam: Parameters<ExamController['getTags']>[0]): Promise<Record<string, unknown>> => ({
  ...exam,
...
export const serverDown = async (server: Server, callback: () => void): Promise<void> => {
  server.close(() => {
