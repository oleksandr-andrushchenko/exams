...
import { ButtonGroup, Input, Option, Select, Tab, Tabs, TabsHeader, Typography } from '@/components/bootstrap'
    ...
    {(Object.keys(tabs).length > 0) && (
            <div className="d-flex gap-5 align-items-center mt-4">
              {Object.entries(tabs).map(([filter, values]) => (
                      <div key={filter} className="d-flex gap-2 align-items-center">
