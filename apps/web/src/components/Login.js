...
const Login = ({ onSubmit, buttons, onRegisterClick }) => {
 ...
 <react_1.Typography variant="small" color="gray" className="mt-4 fw-normal">
 Don't have an account?
 {onRegisterClick
 ? <react_1.Button variant="text" className="fw-medium text-secondary" onClick={onRegisterClick}>Register</react_1.Button>
 : <react_router_dom_1.Link className="fw-medium text-secondary" to={Route_1.default.Register}>Register</react_router_dom_1.Link>}
 </react_1.Typography>
 </div>
 </formik_1.Form>)}
 </formik_1.Formik>);
