      ...
      <react_1.Card>
        <react_1.CardBody className="flex flex-col gap-4">
          ...
          <react_1.Tabs value={activeTab}>
            <react_1.TabsHeader className="rounded-none border-b border-blue-gray-50 bg-transparent p-0" indicatorProps={{ className: 'bg-transparent border-b-2 border-gray-900 shadow-none rounded-none' }}>
