...
function FormikCheckbox({ name, label, children }) {
    ...
    return (<div className="flex flex-col gap-1">
      <react_1.Checkbox {...input} name={name} defaultChecked={input.value} label={label || (<react_1.Typography variant="small" color="gray" className="flex items-center font-normal">
            {children}
          </react_1.Typography>)}/>
