...
export const defaultChoices = () => [
  {
    title: 'Use the managed service designed for this requirement',
    correct: true,
    explanation: 'Managed services reduce operational work and provide documented reliability guarantees.'
  },
  {
    title: 'Run the workload on a single manually managed server',
    correct: false,
    explanation: 'A single server introduces avoidable operational work and a single point of failure.'
  },
  {
    title: 'Store the data only on a developer workstation',
    correct: false,
    explanation: 'Developer workstations are not durable production storage.'
  }
]
