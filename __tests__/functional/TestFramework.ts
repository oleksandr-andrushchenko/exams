...
import ExamRepository from '../../src/server/repositories/exam/ExamRepository'
import QuestionRepository from '../../src/server/repositories/question/QuestionRepository'
import ExamSessionRepository from '../../src/server/repositories/ExamSessionRepository'
...
import Token from '../../src/server/schema/auth/Token'
...
import QuestionChoice from '../../src/server/entities/question/QuestionChoice'
import ExamSessionQuestion from '../../src/server/entities/examSession/ExamSessionQuestion'
import Rating from '../../src/server/entities/rating/Rating'
import AccessTokenCreator from '../../src/server/services/auth/AccessTokenCreator'
import Activity from '../../src/server/entities/activity/Activity'
import ActivityRepository from '../../src/server/repositories/ActivityRepository'
import ExamEvent from '../../src/server/enums/exam/ExamEvent'
import EntityRepository from '../../src/server/repositories/EntityRepository'
import ExamRatingMark from '../../src/server/entities/exam/ExamRatingMark'
import QuestionRatingMark from '../../src/server/entities/question/QuestionRatingMark'
import ExamRatingMarkRepository from '../../src/server/repositories/exam/ExamRatingMarkRepository'
import QuestionRatingMarkRepository from '../../src/server/repositories/question/QuestionRatingMarkRepository'
import config from '../../src/server/configuration'
import ExamTag from '../../src/server/entities/examTag/ExamTag'
import ExamTagRepository from '../../src/server/repositories/examTag/ExamTagRepository'
...
export default class TestFramework {
  ...
  public constructor() {
    const { testServerUp, testServerDown } = require('../../src/server/application')
